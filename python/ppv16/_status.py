...
class ErrorMsgType (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 3, 1)
...
class ErrorCodeType (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 11, 1)
...
class STD_ANON (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 50, 4)
    _Documentation = None
...
class STD_ANON_ (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 60, 4)
    _Documentation = None
...
class STD_ANON_2 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 70, 4)
    _Documentation = None
...
class StatusType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 20, 1)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __code._DeclarationLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 26, 4)
    __code._UseLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 26, 4)
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 45, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __version._DeclarationLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 46, 3)
    __version._UseLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 46, 3)
    ...
    __ttversion._DeclarationLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 56, 3)
    __ttversion._UseLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 56, 3)
    ...
    __ttrefversion._DeclarationLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 66, 3)
    __ttrefversion._UseLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 66, 3)
...
class CTD_ANON_ (StatusType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 35, 2)
...
PPConnect = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PPConnect'), pyxb.binding.datatypes.anyType, documentation='Signal end of the setup phase and switch to use the requested PP data schema.', location=pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 78, 1))
Namespace.addCategoryObject('elementBinding', PPConnect.name().localName(), PPConnect)

PPReqVersion = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PPReqVersion'), CTD_ANON, documentation='Request the schema versions required by the client', location=pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 41, 1))
Namespace.addCategoryObject('elementBinding', PPReqVersion.name().localName(), PPReqVersion)

PPStatus = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PPStatus'), CTD_ANON_, documentation='Setup phase status/heartbeat response', location=pyxb.utils.utility.Location('C:\\Users\\robin\\Projects\\train-mood-map\\python\\ppv16\\rttiPPTStatus_v1.xsd', 31, 1))
